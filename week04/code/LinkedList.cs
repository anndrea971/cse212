...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If it's the head, use the existing RemoveHead function
                if (curr == _head)
                {
                    RemoveHead();
                }
                // If it's the tail, use the existing RemoveTail function
                else if (curr == _tail)
                {
                    RemoveTail();
                }
                // If it's somewhere in the middle, bypass the current node
                else
                {
